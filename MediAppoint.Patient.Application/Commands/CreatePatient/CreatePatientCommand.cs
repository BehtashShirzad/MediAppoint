...
{
    public record CreatePatientCommand(string UserName,string FullName,string NationalCode, List<AddressModel> Addresses) :IRequest<Result<CreatePatientCommandResponse>>;
