...
namespace MediAppoint.Patient.Infrastructure.Migrations
{
    ...
    [Migration("20250906070547_AddPatientAddressesTable")]
    partial class AddPatientAddressesTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MediAppoint.Patient.Domain.Core.Patient", b =>
                {
                    b.OwnsMany("MediAppoint.Patient.Domain.ValueObjects.Address", "Addresses", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.ToTable("PatientAddresses", (string)null);
